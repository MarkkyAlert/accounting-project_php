...
<body>
    ...
    <div class="container login-card-custom ">
        ...
        <h2 class="text-center mt-5 mb-5">สรุปรายรับ</h2>
        <?php
        $select_stmt = $db->prepare("SELECT * FROM months ORDER BY month_id DESC");
        ...
        <div class="row p-5 card">
            <?php foreach ($select_stmt as $row) { ?>
                <div class="col-md-12 mb-4">
                    ...
                    <div class="flex btn btn-light" style=" display: flex; justify-content: space-between; pointer-events: none; font-size: 16px;">
                        <p style="align-self:center;"><?php echo $row['month_name']; ?></p>
                        <p class="text-success" style="align-self:center;">+ <?php echo number_format($row['income']); ?></p>
