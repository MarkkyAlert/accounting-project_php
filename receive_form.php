...
<body>
    ...
    <div class="container login-card-custom ">
        ...
        <h2 class="text-center mt-5 mb-5">ฟอร์มบัญชีรายรับ</h2>
        <?php if (isset($_SESSION['err_receive'])) : ?>
            <div class="alert alert-danger" role="alert">
                <?php echo $_SESSION['err_receive']; ?>
            </div>
        <?php endif; ?>
        ...
        <form style="margin:0 auto;" class="p-5 card " method="post" action="receive_form_db.php">
            <!-- Email input -->
            <div class="row">
...
<?php
    if (isset($_SESSION['err_receive']) || isset($_SESSION['err_fill'])) {
        unset($_SESSION['err_receive']);
