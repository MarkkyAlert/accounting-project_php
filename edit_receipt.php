...
<body>
    ...
    <div class="container login-card-custom ">
        ...
        <form style="margin:0 auto;" class="p-5 card " method="post" action="edit_receipt_db2.php">
            <!-- Email input -->
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" name="price" id="form1Example1" class="form-control" value="<?php echo $_SESSION['price']; ?>" />
                        <label class="form-label" for="form1Example1">ราคาต่อคอร์ส</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" name="amount" id="form1Example1" class="form-control" value="<?php echo $_SESSION['amount']; ?>"/>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-outline mb-4">
                        ...
                        <input name="date" class="form-control" type="date" placeholder="date" value="<?php echo $_SESSION['date']; ?>" max="<?php echo date("Y-m-d"); ?>" />
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" disabled name="firstname" value="<?php echo $_SESSION['firstname']; ?>" id="form1Example1" class="form-control" />
                        <label class="form-label" for="form1Example1">ชื่อ</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" disabled name="lastname" value="<?php echo $_SESSION['lastname']; ?>" id="form1Example1" class="form-control" />
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" disabled name="email" value="<?php echo $_SESSION['email']; ?>" id="form1Example1" class="form-control" />
                        <label class="form-label" for="form1Example1">อีเมล์</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" disabled name="phone" value="<?php echo $_SESSION['phone']; ?>" id="form1Example1" class="form-control" />
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-outline mb-4">
                        <textarea class="form-control" name="address" disabled id="textAreaExample" rows="4"><?php echo $_SESSION['address'];; ?></textarea>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-outline mb-4">
                        <input type="text" name="company" id="form1Example1" class="form-control" value="<?php echo $_SESSION['company']; ?>"/>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-outline mb-4">
                        <input type="text" name="company_address" id="form1Example1" class="form-control" value="<?php echo $_SESSION['company_address']; ?>"/>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" name="company_phone" id="form1Example1" class="form-control" value="<?php echo $_SESSION['company_phone']; ?>"/>
                        <label class="form-label" for="form1Example1">โทรศัพท์</label>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-outline mb-4">
                        <input type="text" name="company_tax" id="form1Example1" class="form-control" value="<?php echo $_SESSION['company_tax']; ?>"/>
                        <label class="form-label" for="form1Example1">เลขผู้เสียภาษี</label>
                    </div>
                </div>
            </div>
            <input type="hidden" value="<?php echo $_SESSION['reference']; ?>">
