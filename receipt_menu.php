...
<body>
    ...
    <div class="container login-card-custom ">
        ...
        <div class="row p-5 card text-center">
            <div class="col-md-12">
                <a class="btn btn-lg btn-info mb-3 w-100" href="show_receipt.php">ดูใบเสร็จทั้งหมด</a> <br>
                <a class="btn btn-lg btn-info mb-3 w-100" href="receipt_form.php">สร้างฟอร์มใบเสร็จ</a><br>
            </div>
        </div>
    </div>
